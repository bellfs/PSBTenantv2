...
export default function Settings() {
  ...
  const [imapForm, setImapForm] = useState({ email_address: 'info@psb.properties', host: 'imappro.zoho.eu', port: 993, username: 'info@psb.properties', password: '' });
          ...
          <div className="card-body">
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12}}>
              ...
              <div className="form-group"><label className="form-label">IMAP Host</label>
                <input className="form-input" value={imapForm.host} onChange={e=>setImapForm(f=>({...f,host:e.target.value}))} placeholder="imappro.zoho.eu"/></div>
